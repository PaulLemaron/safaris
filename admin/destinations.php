...
<body>
    ...
    <section class="main-dashboard">
        ...
        <div class="div-action pull pull-right" style="padding-bottom:20px;">
          <button class="btn btn-primary button1" data-toggle="modal" data-target="#addBrandModel"> <i class="glyphicon glyphicon-plus-sign"></i> Add Destination</button>
        </div> <!-- /div-action --> <br>
        <br>
        <?php 
                      ...
                      $select = mysqli_query($conn,"select * from destinations");
                       ...
                       while($rowcompany=mysqli_fetch_array($select)){
                        ...
                        <tr>
                            ...
                            <?php $counter++; ?>
                            <td><img src="php_action/images/<?php echo $rowcompany['dimage'];  ?>" alt=""></td>
                            <td><?php echo $rowcompany['location'];?></td>
                            <td><?php echo $rowcompany['description'];?></td>
                            <td><?php echo $rowcompany['price'];?></td>
                            <td> 
                              ...
                              <button class="btn btn-danger"><a href="newImage.php?destination_id=<?php echo $destination_id;?>" style="color:white;text-decoration:none;"> Change Image </a></button>
